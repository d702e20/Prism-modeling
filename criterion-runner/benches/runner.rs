            ...
            group.bench_function(stringify!($name), |b| {
                b.iter(|| {
                    ...
                    if !cmd.status.success() {
                        ...
                        println!("stdout of {}: {}", stringify!($name), String::from_utf8_lossy(&cmd.stdout));
                    }
                })
            });
            group.finish();
...
// Gossiping girls
bench!(
    gossipping_girls_all_girls_ensure_player_one_gets_omniscient_before_10_steps_TRUE,
...
bench!(
    gossipping_girls_all_girls_ensure_that_all_girls_omnicient_before_10_steps_TRUE,
    "gossipping-girls/gossipping-circular.prism",
    "gossipping-girls/all_girls_ensure_that_all_girls_omnicient_before_10_steps_TRUE.props"
);
bench!(gossipping_girls_all_girls_ensure_that_only_player_one_gets_omniscient_before_10_steps_TRUE,
    "gossipping-girls/gossipping-circular.prism",
    "gossipping-girls/all_girls_ensure_that_only_player_one_gets_omniscient_before_10_steps_TRUE.props");
bench!(
    gossipping_girls_all_omniscient_but_first_after_10_steps_TRUE,
    "gossipping-girls/gossipping-circular.prism",
    "gossipping-girls/all_omniscient_but_first_after_10_steps_TRUE.props"
);
bench!(
    gossipping_girls_eventually_10_steps_are_passed_TRUE,
    "gossipping-girls/gossipping-circular.prism",
    "gossipping-girls/eventually_10_steps_are_passed_TRUE.props"
);
bench!(
    gossipping_girls_girl_one_gurantee_to_become_omniscient_before_10_steps_FALSE,
    "gossipping-girls/gossipping-circular.prism",
    "gossipping-girls/girl_one_gurantee_to_become_omniscient_before_10_steps_FALSE.props"
);
bench!(
    gossipping_girls_guarantee_all_girls_eventually_become_omniscient_but_not_girl_one_TRUE,
    "gossipping-girls/gossipping-circular.prism",
...
criterion_group!(
    ...
    gossipping_girls_all_girls_ensure_player_one_gets_omniscient_before_10_steps_TRUE,
    gossipping_girls_all_girls_ensure_that_all_girls_omnicient_before_10_steps_TRUE,
    gossipping_girls_all_girls_ensure_that_only_player_one_gets_omniscient_before_10_steps_TRUE,
    gossipping_girls_all_omniscient_but_first_after_10_steps_TRUE,
    gossipping_girls_eventually_10_steps_are_passed_TRUE,
    gossipping_girls_girl_one_gurantee_to_become_omniscient_before_10_steps_FALSE,
    gossipping_girls_guarantee_all_girls_eventually_become_omniscient_but_not_girl_one_TRUE
